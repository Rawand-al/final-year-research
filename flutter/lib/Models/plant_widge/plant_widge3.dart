...
class PlantWidget3 extends StatelessWidget {
  const PlantWidget3({
    Key?key, required this.index, required this.plantList3,
   
  }) :super (key: key);


 final int index;
 final List plantList3;

  @override
  Widget build(BuildContext context) {
    Size size=MediaQuery.of(context).size;
    List<Plant3>_plantList=Plant3.plantList3;
    return GestureDetector(
      onTap: () {
                       Navigator.push(context, PageTransition(child: DetailPage3(
    plantId: index,
