...
class Plant3 {
  ...
  static List<Plant3> plantList3 = [
    Plant3(
      ...
      name: 'بیبەر',
      imageURL:
'https://static.vecteezy.com/system/resources/previews/018/743/086/original/bell-pepper-isolated-png.png',      temperature: '١٥-٢٤',
    ...
    Plant3(
      ...
      Catagoris: 'پایز',
      name: 'تەماتە',
      imageURL:'https://static.vecteezy.com/system/resources/previews/011/704/547/non_2x/isolated-tomato-on-transparent-background-free-png.png',
      ...
      isFavorated3: false,
      isSelected3: true, temperature: '٢٢-١٥',
    ),
    Plant3(
      plantId: 3,
      Catagoris: 'هاوین',
